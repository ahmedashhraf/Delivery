...
public class AlertDialogLayout extends C0490e0 {
    public AlertDialogLayout(@C0195i0 Context context) {
        super(context);
    }

    /* renamed from: a */
    private void m2396a(View view, int i, int i2, int i3, int i4) {
        view.layout(i, i2, i3 + i, i4 + i2);
    }

    /* renamed from: c */
    private void m2398c(int i, int i2) {
        int makeMeasureSpec = MeasureSpec.makeMeasureSpec(getMeasuredWidth(), C6637f.f18605b);
        for (int i3 = 0; i3 < i; i3++) {
            View childAt = getChildAt(i3);
            if (childAt.getVisibility() != 8) {
                C0492b bVar = (C0492b) childAt.getLayoutParams();
                if (bVar.width == -1) {
                    int i4 = bVar.height;
    ...
    /* renamed from: d */
    private boolean m2399d(int i, int i2) {
        int i3;
        int i4;
        int i5;
        int i6;
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0238R.C0241id.topPanel) {
                    view = childAt;
                } else if (id == C0238R.C0241id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0238R.C0241id.contentPanel && id != C0238R.C0241id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
        ...
        if (view2 != null) {
            ...
            view2.measure(i8, MeasureSpec.makeMeasureSpec(i5, C6637f.f18605b));
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            androidx.appcompat.widget.e0$b r15 = (androidx.appcompat.widget.C0490e0.C0492b) r15
            int r2 = r15.f1973b
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = androidx.core.p034l.C0962e0.m5566x(r17)
            int r2 = androidx.core.p034l.C0984g.m5636a(r2, r3)
            r2 = r2 & 7
            r3 = 1
    ...
    public AlertDialogLayout(@C0195i0 Context context, @C0195i0 AttributeSet attributeSet) {
        super(context, attributeSet);
    }

    /* renamed from: c */
    private static int m2397c(View view) {
        int C = C0962e0.m5399C(view);
        if (C > 0) {
            return C;
        }
        if (view instanceof ViewGroup) {
            ...
            if (viewGroup.getChildCount() == 1) {
                return m2397c(viewGroup.getChildAt(0));
            }
        }
        return 0;
    }
