...
public abstract class BaseStrokeContent implements AnimationListener, KeyPathElementContent, DrawingContent {
    ...
    /* renamed from: pm */
    private final PathMeasure f9982pm = new PathMeasure();
    ...
    private static final class PathGroup {
        ...
        private PathGroup(@C0195i0 TrimPathContent trimPathContent) {
    ...
    private void applyTrimPath(Canvas canvas, PathGroup pathGroup, Matrix matrix) {
        ...
        this.f9982pm.setPath(this.path, false);
        float length = this.f9982pm.getLength();
        while (this.f9982pm.nextContour()) {
            length += this.f9982pm.getLength();
        }
        ...
        for (int size2 = pathGroup.paths.size() - 1; size2 >= 0; size2--) {
            ...
            this.f9982pm.setPath(this.trimPathPath, false);
            float length2 = this.f9982pm.getLength();
            float f2 = 1.0f;
