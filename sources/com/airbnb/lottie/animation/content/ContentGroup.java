...
public class ContentGroup implements DrawingContent, PathContent, AnimationListener, KeyPathElement {
    ...
    ContentGroup(LottieDrawable lottieDrawable2, BaseLayer baseLayer, String str, boolean z, List<Content> list, @C0195i0 AnimatableTransform animatableTransform) {
