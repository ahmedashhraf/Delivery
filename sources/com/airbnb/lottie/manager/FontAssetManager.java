...
public class FontAssetManager {
    ...
    public FontAssetManager(Callback callback, @C0195i0 FontAssetDelegate fontAssetDelegate) {
    ...
    public void setDelegate(@C0195i0 FontAssetDelegate fontAssetDelegate) {
        this.delegate = fontAssetDelegate;
    }
}
