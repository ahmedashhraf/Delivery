...
public class CompositionLayer extends BaseLayer {
    ...
    static /* synthetic */ class C28471 {
        ...
        static {
            ...
            L_0x001f:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.model.layer.CompositionLayer.C28471.<clinit>():void");
        }
    }
    ...
    public CompositionLayer(LottieDrawable lottieDrawable, Layer layer, List<Layer> list, LottieComposition lottieComposition) {
        ...
        C0642f fVar = new C0642f(lottieComposition.getLayers().size());
        ...
        while (true) {
            ...
            if (forModel != null) {
                fVar.mo3284c(forModel.getLayerModel().getId(), forModel);
                if (baseLayer != null) {
                    baseLayer.setMatteLayer(forModel);
                    baseLayer = null;
                } else {
                    this.layers.add(0, forModel);
                    int i2 = C28471.$SwitchMap$com$airbnb$lottie$model$layer$Layer$MatteType[layer2.getMatteType().ordinal()];
                    if (i2 == 1 || i2 == 2) {
                        baseLayer = forModel;
                    }
                }
        ...
        for (i = 0; i < fVar.mo3287d(); i++) {
            BaseLayer baseLayer2 = (BaseLayer) fVar.mo3283c(fVar.mo3270a(i));
            if (baseLayer2 != null) {
                BaseLayer baseLayer3 = (BaseLayer) fVar.mo3283c(baseLayer2.getLayerModel().getParentId());
                if (baseLayer3 != null) {
