...
public class Layer {
    ...
    public Layer(List<ContentModel> list, LottieComposition lottieComposition, String str, long j, LayerType layerType2, long j2, @C0195i0 String str2, List<Mask> list2, AnimatableTransform animatableTransform, int i, int i2, int i3, float f, float f2, int i4, int i5, @C0195i0 AnimatableTextFrame animatableTextFrame, @C0195i0 AnimatableTextProperties animatableTextProperties, List<Keyframe<Float>> list3, MatteType matteType2, @C0195i0 AnimatableFloatValue animatableFloatValue, boolean z) {
        this.shapes = list;
