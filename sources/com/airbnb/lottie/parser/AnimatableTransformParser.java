...
public class AnimatableTransformParser {
    private static Options ANIMATABLE_NAMES = Options.m13419of("k");
    private static Options NAMES = Options.m13419of("a", XHTMLText.f45024P, "s", "rz", AckRequest.ELEMENT, "o", "so", "eo", "sk", "sa");
    ...
    public static AnimatableTransform parse(JsonReader jsonReader, LottieComposition lottieComposition) throws IOException {
        ...
        boolean z = false;
        boolean z2 = jsonReader.peek() == Token.BEGIN_OBJECT;
        if (z2) {
