...
class GradientStrokeParser {
    private static final Options DASH_PATTERN_NAMES = Options.m13419of("n", C11687c.f33838t0);
    private static final Options GRADIENT_NAMES = Options.m13419of(XHTMLText.f45024P, "k");
    private static Options NAMES = Options.m13419of("nm", "g", "o", "t", "s", "e", "w", "lc", "lj", "ml", "hd", C2945d.f10439h);
                ...
                case 11:
                    ...
                    while (jsonReader.hasNext()) {
                        ...
                        if (str2.equals("o")) {
                            ...
                            if (str2.equals(C2945d.f10439h) || str2.equals("g")) {
