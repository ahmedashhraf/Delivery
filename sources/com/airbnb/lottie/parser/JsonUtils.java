...
class JsonUtils {
    private static final Options POINT_NAMES = Options.m13419of("x", "y");
    ...
    static /* synthetic */ class C28511 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.airbnb.lottie.parser.JsonUtils.C28511.<clinit>():void");
        }
    }
    ...
    static PointF jsonToPoint(JsonReader jsonReader, float f) throws IOException {
        int i = C28511.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[jsonReader.peek().ordinal()];
        if (i == 1) {
    ...
    static float valueFromObject(JsonReader jsonReader) throws IOException {
        ...
        int i = C28511.$SwitchMap$com$airbnb$lottie$parser$moshi$JsonReader$Token[peek.ordinal()];
        if (i == 1) {
