...
final class JsonUtf8Reader extends JsonReader {
    private static final C13896f CLOSING_BLOCK_COMMENT = C13896f.m59655e("*/");
    private static final C13896f DOUBLE_QUOTE_OR_SLASH = C13896f.m59655e(C15329f.f44379c);
    private static final C13896f LINEFEED_OR_CARRIAGE_RETURN = C13896f.m59655e("\n\r");
    ...
    private static final C13896f SINGLE_QUOTE_OR_SLASH = C13896f.m59655e("'\\");
    private static final C13896f UNQUOTED_STRING_TERMINALS = C13896f.m59655e("{}[]:, \n\t\r\f/\\;#=");
    private final C13887c buffer;
    private int peeked = 0;
    private long peekedLong;
    private int peekedNumberLength;
    @C0195i0
    private String peekedString;
    private final C13894e source;

    JsonUtf8Reader(C13894e eVar) {
        if (eVar != null) {
            this.source = eVar;
            this.buffer = eVar.mo43872c();
            pushScope(6);
            return;
        }
        ...
        if (i2 == 1) {
            ...
            if (nextNonWhitespace4 != 58) {
                if (nextNonWhitespace4 == 61) {
                    checkLenient();
                    if (this.source.mo43874c(1) && this.buffer.mo43836a(0) == 62) {
                        this.buffer.readByte();
                    }
                } else {
            ...
            if (!(nextNonWhitespace5 == 44 || nextNonWhitespace5 == 59)) {
                if (nextNonWhitespace5 == 91) {
                    ...
                    if (nextNonWhitespace5 != 123) {
                        ...
                        if (isLiteral(this.buffer.mo43836a(0))) {
                            checkLenient();
                            this.peeked = 10;
                            return 10;
                        }
    ...
    /* JADX INFO: used method not loaded: h.c.a(long):null, types can be incorrect */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0039, code lost:
        if (r6.source.mo43874c(2) != false) goto L_0x003c;
     */
    ...
    private int nextNonWhitespace(boolean r7) throws java.io.IOException {
        ...
        L_0x0002:
            ...
            int r3 = r1 + 1
            long r4 = (long) r3
            boolean r2 = r2.mo43874c(r4)
            if (r2 == 0) goto L_0x0082
            h.c r2 = r6.buffer
            long r4 = (long) r1
            byte r1 = r2.mo43836a(r4)
            r2 = 10
    ...
    private String nextQuotedValue(C13896f fVar) throws IOException {
        StringBuilder sb = null;
        while (true) {
            long c = this.source.mo43871c(fVar);
            if (c == -1) {
                throw syntaxError("Unterminated string");
            } else if (this.buffer.mo43836a(c) == 92) {
                if (sb == null) {
                    sb = new StringBuilder();
                }
                sb.append(this.buffer.mo43889g(c));
                this.buffer.readByte();
                sb.append(readEscapeCharacter());
            } else if (sb == null) {
                String g = this.buffer.mo43889g(c);
                this.buffer.readByte();
                return g;
            } else {
                sb.append(this.buffer.mo43889g(c));
    ...
    private String nextUnquotedValue() throws IOException {
        long c = this.source.mo43871c(UNQUOTED_STRING_TERMINALS);
        return c != -1 ? this.buffer.mo43889g(c) : this.buffer.mo43923w();
    }
    ...
    private int peekKeyword() throws IOException {
        ...
        while (i2 < length) {
            int i3 = i2 + 1;
            if (!this.source.mo43874c((long) i3)) {
                return 0;
            }
            byte a2 = this.buffer.mo43836a((long) i2);
            if (a2 != str2.charAt(i2) && a2 != str.charAt(i2)) {
                return 0;
            }
            i2 = i3;
        }
        if (this.source.mo43874c((long) (length + 1)) && isLiteral(this.buffer.mo43836a((long) length))) {
            return 0;
        }
    ...
    private int peekNumber() throws IOException {
        ...
        while (true) {
            ...
            a = this.buffer.mo43836a((long) i2);
            if (a != 43) {
                if (a != 69 && a != 101) {
                    if (a != 45) {
                        if (a != 46) {
                            if (a >= 48 && a <= 57) {
                                if (c == z || c == 0) {
                                    ...
                                    if (c == 2) {
                                        ...
                                        z2 = (j > MIN_INCOMPLETE_INTEGER || (j == MIN_INCOMPLETE_INTEGER && j2 < j)) & z2;
                                        j = j2;
                                    } else if (c == 3) {
                                        i = 0;
                                        c = 4;
    ...
    private char readEscapeCharacter() throws IOException {
        ...
        if (this.source.mo43874c(1)) {
            ...
            } else if (this.source.mo43874c(4)) {
                char c = 0;
                for (int i3 = 0; i3 < 4; i3++) {
                    byte a = this.buffer.mo43836a((long) i3);
                    char c2 = (char) (c << 4);
                    if (a < 48 || a > 57) {
                        if (a >= 97 && a <= 102) {
                            i = a - 97;
                            ...
                            sb2.append("\\u");
                            sb2.append(this.buffer.mo43889g(4));
    ...
    private void skipQuotedValue(C13896f fVar) throws IOException {
        while (true) {
            long c = this.source.mo43871c(fVar);
            if (c == -1) {
                throw syntaxError("Unterminated string");
            } else if (this.buffer.mo43836a(c) == 92) {
                this.buffer.skip(c + 1);
                readEscapeCharacter();
            } else {
                this.buffer.skip(c + 1);
                return;
    ...
    private boolean skipToEndOfBlockComment() throws IOException {
        long b = this.source.mo43864b(CLOSING_BLOCK_COMMENT);
        boolean z = b != -1;
        C13887c cVar = this.buffer;
        cVar.skip(z ? b + ((long) CLOSING_BLOCK_COMMENT.mo43985r()) : cVar.size());
        return z;
    }

    private void skipToEndOfLine() throws IOException {
        long c = this.source.mo43871c(LINEFEED_OR_CARRIAGE_RETURN);
        C13887c cVar = this.buffer;
        cVar.skip(c != -1 ? c + 1 : cVar.size());
    }
    ...
    public double nextDouble() throws IOException {
        ...
        String str2 = " at path ";
        if (i == 17) {
            this.peekedString = this.buffer.mo43889g((long) this.peekedNumberLength);
        } else if (i == 9) {
    ...
    public String nextString() throws IOException {
        ...
        if (i == 10) {
            ...
            str = this.buffer.mo43889g((long) this.peekedNumberLength);
        } else {
            StringBuilder sb = new StringBuilder();
    ...
    public int selectName(Options options) throws IOException {
        ...
        int a = this.source.mo43837a(options.doubleQuoteSuffix);
        if (a != -1) {
            this.peeked = 0;
