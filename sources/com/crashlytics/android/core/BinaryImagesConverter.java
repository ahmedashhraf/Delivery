...
class BinaryImagesConverter {
    ...
    private File correctDataPath(File file) {
        ...
        if (file.getAbsolutePath().startsWith(DATA_DIR)) {
            try {
                ...
                C14215d.m61672j().mo45045e(CrashlyticsCore.TAG, "Error getting ApplicationInfo", e);
            }
        }
        return file;
    }
    ...
    private static JSONObject createBinaryImageJson(String str, ProcMapEntry procMapEntry) throws JSONException {
        ...
        jSONObject.put(NetworkManager.UUID, str);
        return jSONObject;
    }
    ...
    private static byte[] generateBinaryImagesJsonString(JSONArray jSONArray) {
        ...
        try {
            ...
            C14215d.m61672j().mo45052w(CrashlyticsCore.TAG, "Binary images string is null", e);
            return new byte[0];
        }
    }
        ...
        if (parse != null && isRelevant(parse)) {
            try {
                try {
                    ...
                    C14215d.m61672j().mo45043d(str2, "Could not create a binary image json string", e);
                    return null;
                }
                ...
                j.mo45043d(str2, sb.toString(), e2);
            }
        }
        return null;
    }
    ...
    private JSONArray parseProcMapsJsonFromString(String str) {
        ...
        try {
            ...
            C14215d.m61672j().mo45052w(CrashlyticsCore.TAG, "Unable to parse proc maps string", e);
            return jSONArray;
        }
    }
