...
class DefaultAppMeasurementEventListenerRegistrar implements AppMeasurementEventListenerRegistrar {
    ...
    public static void writeEventToUserLog(CrashlyticsCore crashlyticsCore2, String str, Bundle bundle) {
        try {
            ...
            sb2.append(str);
            j.mo45051w(CrashlyticsCore.TAG, sb2.toString());
        }
    }
        ...
        if (this.eventListenerProxy == null) {
            this.eventListenerProxy = Proxy.newProxyInstance(this.crashlyticsCore.getContext().getClassLoader(), new Class[]{cls}, new InvocationHandler() {
                ...
                public Object invoke(Object obj, Method method, Object[] objArr) {
                    ...
                    C14215d.m61672j().mo45044e(CrashlyticsCore.TAG, sb2.toString());
                    return null;
                }
            });
        }
    ...
    public boolean register() {
        ...
        if (cls == null) {
            C14215d.m61672j().mo45042d(str, "Firebase Analytics is not present; you will not see automatic logging of events before a crash occurs.");
            return false;
        }
        Object instance = getInstance(cls);
        if (instance == null) {
            C14215d.m61672j().mo45051w(str, "Cannot register AppMeasurement Listener for Crashlytics breadcrumbs: Could not create an instance of Firebase Analytics.");
            return false;
        }
        Class cls2 = getClass(ANALYTIC_CLASS_ON_EVENT_LISTENER);
        if (cls2 == null) {
            C14215d.m61672j().mo45051w(str, "Cannot register AppMeasurement Listener for Crashlytics breadcrumbs: Could not get class com.google.android.gms.measurement.AppMeasurement$OnEventListener");
            return false;
        }
        try {
            cls.getDeclaredMethod(REGISTER_METHOD, new Class[]{cls2}).invoke(instance, new Object[]{getOnEventListenerProxy(cls2)});
        } catch (NoSuchMethodException e) {
            C14215d.m61672j().mo45052w(str, "Cannot register AppMeasurement Listener for Crashlytics breadcrumbs: Method registerOnMeasurementEventListener not found.", e);
            return false;
        } catch (Exception e2) {
            C14228l j = C14215d.m61672j();
            StringBuilder sb = new StringBuilder();
