...
class SessionProtobufHelper {
    ...
    private static int getDeviceIdentifierSize(C14266a aVar, String str) {
    ...
    private static int getSessionDeviceSize(int i, ByteString byteString, int i2, long j, long j2, boolean z, Map<C14266a, String> map, int i3, ByteString byteString2, ByteString byteString3) {
        int i4;
        int i5;
        int i6 = 0;
        ...
        if (map != null) {
            for (Entry entry : map.entrySet()) {
                int deviceIdentifierSize = getDeviceIdentifierSize((C14266a) entry.getKey(), (String) entry.getValue());
    ...
    public static void writeSessionDevice(CodedOutputStream codedOutputStream, int i, String str, int i2, long j, long j2, boolean z, Map<C14266a, String> map, int i3, String str2, String str3) throws Exception {
        ...
        for (Entry entry : map.entrySet()) {
            ...
            codedOutputStream2.writeRawVarint32(getDeviceIdentifierSize((C14266a) entry.getKey(), (String) entry.getValue()));
            codedOutputStream2.writeEnum(1, ((C14266a) entry.getKey()).protobufIndex);
    ...
    public static void writeSessionEvent(CodedOutputStream codedOutputStream, long j, String str, TrimmedThrowableData trimmedThrowableData, Thread thread, StackTraceElement[] stackTraceElementArr, Thread[] threadArr, List<StackTraceElement[]> list, Map<String, String> map, LogFileManager logFileManager, RunningAppProcessInfo runningAppProcessInfo, int i, String str2, String str3, Float f, int i2, boolean z, long j2, long j3) throws Exception {
        ...
        if (byteStringForLog == null) {
            C14215d.m61672j().mo45042d(CrashlyticsCore.TAG, "No log data to include with this event.");
        }
