...
public class CustomTabMainActivity extends Activity {
    ...
    private void sendResult(int i, Intent intent) {
        C2128a.m11089a((Context) this).mo9217a(this.redirectReceiver);
        if (intent != null) {
            setResult(i, intent);
        } else {
            setResult(i);
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (bundle == null) {
            ...
            C2128a.m11089a((Context) this).mo9218a(this.redirectReceiver, new IntentFilter(CustomTabActivity.CUSTOM_TAB_REDIRECT_ACTION));
        }
    }
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (REFRESH_ACTION.equals(intent.getAction())) {
            C2128a.m11089a((Context) this).mo9219a(new Intent(CustomTabActivity.DESTROY_ACTION));
            sendResult(-1, intent);
