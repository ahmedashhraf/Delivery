...
public final class ProfileManager {
    ...
    ProfileManager(C2128a aVar, ProfileCache profileCache2) {
    ...
    static ProfileManager getInstance() {
        if (instance == null) {
            synchronized (ProfileManager.class) {
                if (instance == null) {
                    instance = new ProfileManager(C2128a.m11089a(FacebookSdk.getApplicationContext()), new ProfileCache());
                }
            }
        }
        return instance;
    ...
    /* access modifiers changed from: 0000 */
    public void setCurrentProfile(@C0195i0 Profile profile) {
        setCurrentProfile(profile, true);
    }

    private void setCurrentProfile(@C0195i0 Profile profile, boolean z) {
