...
class AppEvent implements Serializable {
    ...
    private static JSONObject getJSONObjectForAppEvent(String str, String str2, Double d, Bundle bundle, boolean z, @C0195i0 UUID uuid) throws FacebookException, JSONException {
    ...
    public AppEvent(String str, String str2, Double d, Bundle bundle, boolean z, @C0195i0 UUID uuid) throws JSONException, FacebookException {
