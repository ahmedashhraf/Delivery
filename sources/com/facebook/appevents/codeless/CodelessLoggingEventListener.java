...
public class CodelessLoggingEventListener {
    ...
    /* renamed from: com.facebook.appevents.codeless.CodelessLoggingEventListener$1 */
    static /* synthetic */ class C33881 {

        /* renamed from: $SwitchMap$com$facebook$appevents$codeless$internal$EventBinding$ActionType */
        static final /* synthetic */ int[] f11776xe80ad3db = new int[ActionType.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f11776xe80ad3db = r0
                int[] r0 = f11776xe80ad3db     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f11776xe80ad3db     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f11776xe80ad3db     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.appevents.codeless.CodelessLoggingEventListener.C33881.<clinit>():void");
        }
    }
    ...
    public static class AutoLoggingAccessibilityDelegate extends AccessibilityDelegate {
        ...
        public AutoLoggingAccessibilityDelegate(EventBinding eventBinding, View view, View view2) {
            if (eventBinding != null && view != null && view2 != null) {
                ...
                int i = C33881.f11776xe80ad3db[eventBinding.getType().ordinal()];
                if (i == 1) {
