...
public class EventBinding {
    ...
    public static EventBinding getInstanceFromJson(JSONObject jSONObject) throws JSONException, IllegalArgumentException {
        String string = jSONObject.getString(C2176m.f8635e);
        ...
        String string2 = jSONObject.getString(State.KEY_APP_VERSION);
        JSONArray jSONArray = jSONObject.getJSONArray(C15222a.f44141w);
        ...
        JSONArray optJSONArray = jSONObject.optJSONArray(SDKApiEntry.COLUMN_PARAMETERS);
