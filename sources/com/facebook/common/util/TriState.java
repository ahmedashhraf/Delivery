...
public enum TriState {
    ...
    static /* synthetic */ class C34391 {
        ...
        static {
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.common.util.TriState.C34391.<clinit>():void");
        }
    }
    ...
    public boolean asBoolean() {
        int i = C34391.$SwitchMap$com$facebook$common$util$TriState[ordinal()];
        if (i == 1) {
            return true;
        }
        if (i == 2) {
