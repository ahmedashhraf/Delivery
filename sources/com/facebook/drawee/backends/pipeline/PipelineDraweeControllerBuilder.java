...
public class PipelineDraweeControllerBuilder extends AbstractDraweeControllerBuilder<PipelineDraweeControllerBuilder, ImageRequest, CloseableReference<CloseableImage>, ImageInfo> {
    ...
    static /* synthetic */ class C34551 {
        ...
        static final /* synthetic */ int[] f11785x8d44a530 = new int[CacheLevel.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f11785x8d44a530 = r0
                int[] r0 = f11785x8d44a530     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f11785x8d44a530     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f11785x8d44a530     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.drawee.backends.pipeline.PipelineDraweeControllerBuilder.C34551.<clinit>():void");
        }
    }
    ...
    public static RequestLevel convertCacheLevelToRequestLevel(CacheLevel cacheLevel) {
        int i = C34551.f11785x8d44a530[cacheLevel.ordinal()];
        if (i == 1) {
    ...
    public PipelineDraweeControllerBuilder setCustomDrawableFactories(@C5952h ImmutableList<DrawableFactory> immutableList) {
    ...
    public PipelineDraweeControllerBuilder setCustomDrawableFactory(DrawableFactory drawableFactory) {
        ...
        return setCustomDrawableFactories(ImmutableList.m15723of(drawableFactory));
    }

    public PipelineDraweeControllerBuilder setImageOriginListener(@C5952h ImageOriginListener imageOriginListener) {
        this.mImageOriginListener = imageOriginListener;
        return (PipelineDraweeControllerBuilder) getThis();
    }

    public PipelineDraweeControllerBuilder setPerfDataListener(@C5952h ImagePerfDataListener imagePerfDataListener) {
    ...
    public PipelineDraweeControllerBuilder setCustomDrawableFactories(DrawableFactory... drawableFactoryArr) {
        ...
        return setCustomDrawableFactories(ImmutableList.m15723of(drawableFactoryArr));
    }

    public PipelineDraweeControllerBuilder setUri(@C5952h Uri uri) {
        if (uri == null) {
    ...
    public PipelineDraweeControllerBuilder setUri(@C5952h String str) {
