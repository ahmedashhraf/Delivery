...
public class DebugControllerOverlayDrawable extends Drawable implements ImageLoadingTimeListener {
    ...
    private void addDebugText(Canvas canvas, String str, @C5952h Object... objArr) {
        if (objArr == null) {
    ...
    @VisibleForTesting
    public int determineOverlayColor(int i, int i2, @C5952h ScaleType scaleType) {
    ...
    public void setImageFormat(@C5952h String str) {
        this.mImageFormat = str;
    }

    public void setImageId(@C5952h String str) {
        this.mImageId = str;
        invalidateSelf();
    }
