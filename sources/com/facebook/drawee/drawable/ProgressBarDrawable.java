...
public class ProgressBarDrawable extends Drawable implements CloneableDrawable {
    ...
    private void drawHorizontalBar(Canvas canvas, int i, int i2) {
        ...
        int i4 = ((width - (i3 * 2)) * i) / C14236a.DEFAULT_TIMEOUT;
        int i5 = bounds.left + i3;
        int i6 = bounds.bottom - i3;
        int i7 = this.mBarWidth;
        int i8 = i6 - i7;
        this.mRect.set((float) i5, (float) i8, (float) (i5 + i4), (float) (i8 + i7));
        drawBar(canvas, i2);
    }
    ...
    private void drawVerticalBar(Canvas canvas, int i, int i2) {
        ...
        int i3 = this.mPadding;
        int i4 = ((height - (i3 * 2)) * i) / C14236a.DEFAULT_TIMEOUT;
        int i5 = bounds.left + i3;
        int i6 = bounds.top + i3;
        this.mRect.set((float) i5, (float) i6, (float) (i5 + this.mBarWidth), (float) (i6 + i4));
        drawBar(canvas, i2);
    }
    ...
    public void draw(Canvas canvas) {
        if (!this.mHideWhenZero || this.mLevel != 0) {
            if (this.mIsVertical) {
                drawVerticalBar(canvas, C14236a.DEFAULT_TIMEOUT, this.mBackgroundColor);
                drawVerticalBar(canvas, this.mLevel, this.mColor);
            } else {
                drawHorizontalBar(canvas, C14236a.DEFAULT_TIMEOUT, this.mBackgroundColor);
