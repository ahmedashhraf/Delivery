...
public class GenericDraweeHierarchy implements SettableDraweeHierarchy {
    ...
    @C5952h
    private Drawable buildActualImageBranch(Drawable drawable, @C5952h ScaleType scaleType, @C5952h PointF pointF, @C5952h ColorFilter colorFilter) {
        drawable.setColorFilter(colorFilter);
        return WrappingUtils.maybeWrapWithScaleType(drawable, scaleType, pointF);
    }

    @C5952h
    private Drawable buildBranch(@C5952h Drawable drawable, @C5952h ScaleType scaleType) {
    ...
    private void setChildDrawableAtIndex(int i, @C5952h Drawable drawable) {
        if (drawable == null) {
    ...
    public void setBackgroundImage(@C5952h Drawable drawable) {
    ...
    public void setFailureImage(@C5952h Drawable drawable) {
    ...
    public void setOverlayImage(int i, @C5952h Drawable drawable) {
    ...
    public void setPlaceholderImage(@C5952h Drawable drawable) {
    ...
    public void setProgressBarImage(@C5952h Drawable drawable) {
    ...
    public void setRetryImage(@C5952h Drawable drawable) {
        setChildDrawableAtIndex(4, drawable);
    }

    public void setRoundingParams(@C5952h RoundingParams roundingParams) {
    ...
    public void setOverlayImage(@C5952h Drawable drawable) {
