...
public class RoundingParams {
    ...
    public RoundingParams setBorder(@C0198k int i, float f) {
    ...
    public RoundingParams setBorderColor(@C0198k int i) {
        this.mBorderColor = i;
        return this;
    }
    ...
    public RoundingParams setOverlayColor(@C0198k int i) {
