...
public class DraweeHolder<DH extends DraweeHierarchy> implements VisibilityCallback {
    ...
    public DraweeHolder(@C5952h DH dh) {
        if (dh != null) {
            setHierarchy(dh);
        }
    }
    ...
    public static <DH extends DraweeHierarchy> DraweeHolder<DH> create(@C5952h DH dh, Context context) {
    ...
    private void setVisibilityCallback(@C5952h VisibilityCallback visibilityCallback) {
    ...
    public void onDraw() {
        if (!this.mIsControllerAttached) {
            FLog.m15791w(DraweeEventTracker.class, "%x: Draw requested for a non-attached controller %x. %s", Integer.valueOf(System.identityHashCode(this)), Integer.valueOf(System.identityHashCode(this.mController)), toString());
            this.mIsHolderAttached = true;
