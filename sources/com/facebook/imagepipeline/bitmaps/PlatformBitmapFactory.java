...
public abstract class PlatformBitmapFactory {
    ...
    static /* synthetic */ class C34841 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imagepipeline.bitmaps.PlatformBitmapFactory.C34841.<clinit>():void");
        }
    }
    ...
    private static Config getSuitableBitmapConfig(Bitmap bitmap) {
        ...
        int i = C34841.$SwitchMap$android$graphics$Bitmap$Config[config2.ordinal()];
        if (i == 1) {
    ...
    public CloseableReference<Bitmap> createScaledBitmap(Bitmap bitmap, int i, int i2, boolean z, @C5952h Object obj) {
    ...
    public CloseableReference<Bitmap> createBitmap(int i, int i2, Config config, @C5952h Object obj) {
        return createBitmapInternal(i, i2, config);
    }

    public CloseableReference<Bitmap> createBitmap(int i, int i2, @C5952h Object obj) {
    ...
    public CloseableReference<Bitmap> createBitmap(Bitmap bitmap, @C5952h Object obj) {
    ...
    public CloseableReference<Bitmap> createBitmap(Bitmap bitmap, int i, int i2, int i3, int i4, @C5952h Object obj) {
        return createBitmap(bitmap, i, i2, i3, i4, (Matrix) null, false, obj);
    }

    public CloseableReference<Bitmap> createBitmap(Bitmap bitmap, int i, int i2, int i3, int i4, @C5952h Matrix matrix, boolean z) {
        return createBitmap(bitmap, i, i2, i3, i4, matrix, z, (Object) null);
    }

    public CloseableReference<Bitmap> createBitmap(Bitmap bitmap, int i, int i2, int i3, int i4, @C5952h Matrix matrix, boolean z, @C5952h Object obj) {
        Canvas canvas;
    ...
    public CloseableReference<Bitmap> createBitmap(DisplayMetrics displayMetrics, int i, int i2, Config config, @C5952h Object obj) {
    ...
    private CloseableReference<Bitmap> createBitmap(int i, int i2, Config config, boolean z, @C5952h Object obj) {
    ...
    private CloseableReference<Bitmap> createBitmap(DisplayMetrics displayMetrics, int i, int i2, Config config, boolean z, @C5952h Object obj) {
        checkWidthHeight(i, i2);
        ...
        if (config == Config.ARGB_8888 && !z) {
            bitmap.eraseColor(C0962e0.f4343t);
        }
    ...
    public CloseableReference<Bitmap> createBitmap(int[] iArr, int i, int i2, Config config, @C5952h Object obj) {
        CloseableReference<Bitmap> createBitmapInternal = createBitmapInternal(i, i2, config);
    ...
    public CloseableReference<Bitmap> createBitmap(DisplayMetrics displayMetrics, int[] iArr, int i, int i2, Config config, @C5952h Object obj) {
    ...
    public CloseableReference<Bitmap> createBitmap(DisplayMetrics displayMetrics, int[] iArr, int i, int i2, int i3, int i4, Config config, @C5952h Object obj) {
