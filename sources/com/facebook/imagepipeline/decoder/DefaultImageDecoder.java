...
public class DefaultImageDecoder implements ImageDecoder {
    ...
    public CloseableImage decode(EncodedImage encodedImage, int i, QualityInfo qualityInfo, ImageDecodeOptions imageDecodeOptions) {
        ...
        if (map != null) {
            ImageDecoder imageDecoder2 = (ImageDecoder) map.get(imageFormat);
    ...
    public DefaultImageDecoder(ImageDecoder imageDecoder, ImageDecoder imageDecoder2, PlatformDecoder platformDecoder, @C5952h Map<ImageFormat, ImageDecoder> map) {
