...
public class PoolParams {
    ...
    public PoolParams(int i, @C5952h SparseIntArray sparseIntArray) {
        this(i, i, sparseIntArray, 0, Integer.MAX_VALUE, -1);
    }

    public PoolParams(int i, int i2, @C5952h SparseIntArray sparseIntArray) {
        this(i, i2, sparseIntArray, 0, Integer.MAX_VALUE, -1);
    }

    public PoolParams(int i, int i2, @C5952h SparseIntArray sparseIntArray, int i3, int i4, int i5) {
