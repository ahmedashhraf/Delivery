...
public class ArtDecoder implements PlatformDecoder {
    ...
    @VisibleForTesting
    final C0943c<ByteBuffer> mDecodeBuffers;

    public ArtDecoder(BitmapPool bitmapPool, int i, C0943c cVar) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:25:?, code lost:
        com.facebook.common.logging.FLog.m15751e(TAG, "Could not decode region %s, decoding full bitmap instead.", r11);
     */
    ...
    public com.facebook.common.references.CloseableReference<android.graphics.Bitmap> decodeStaticImageFromStream(java.io.InputStream r9, android.graphics.BitmapFactory.Options r10, @p201f.p202a.C5952h android.graphics.Rect r11) {
        /*
            r8 = this;
        ...
        L_0x0011:
            ...
            r10.inBitmap = r2
            androidx.core.k.h$c<java.nio.ByteBuffer> r3 = r8.mDecodeBuffers
            java.lang.Object r3 = r3.mo4743a()
        ...
        L_0x0054:
            ...
            com.facebook.common.logging.FLog.m15751e(r1, r6, r5)     // Catch:{ all -> 0x0066 }
        ...
        L_0x0074:
            androidx.core.k.h$c<java.nio.ByteBuffer> r9 = r8.mDecodeBuffers
            r9.release(r3)
            if (r2 != r11) goto L_0x0082
            com.facebook.imagepipeline.memory.BitmapPool r9 = r8.mBitmapPool
            com.facebook.common.references.CloseableReference r9 = com.facebook.common.references.CloseableReference.m15818of(r11, r9)
            return r9
        L_0x0082:
            com.facebook.imagepipeline.memory.BitmapPool r9 = r8.mBitmapPool
            r9.release(r2)
        ...
        L_0x0099:
            ...
            com.facebook.common.references.CloseableReference r9 = com.facebook.common.references.CloseableReference.m15818of(r9, r11)     // Catch:{ IOException -> 0x00b7 }
            androidx.core.k.h$c<java.nio.ByteBuffer> r10 = r8.mDecodeBuffers
            r10.release(r3)
            return r9
        L_0x00b6:
