...
public class LocalExifThumbnailProducer implements ThumbnailProducer<EncodedImage> {
    ...
    public EncodedImage buildEncodedImage(PooledByteBuffer pooledByteBuffer, ExifInterface exifInterface) {
        ...
        CloseableReference of = CloseableReference.m15817of(pooledByteBuffer);
        try {
    ...
    private int getRotationAngle(ExifInterface exifInterface) {
        return JfifUtil.getAutoRotateAngleFromOrientation(Integer.parseInt(exifInterface.getAttribute(C2108a.f8392y)));
    }
    ...
    public ExifInterface getExifInterface(Uri uri) {
        ...
        try {
            ...
            FLog.m15749e(LocalExifThumbnailProducer.class, "StackOverflowError in ExifInterface constructor");
        }
        return null;
    }
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        final C35331 r0 = new StatefulProducerRunnable<EncodedImage>(consumer, listener, PRODUCER_NAME, id) {
            ...
            public Map<String, String> getExtraMapOnSuccess(EncodedImage encodedImage) {
                return ImmutableMap.m15725of(LocalExifThumbnailProducer.CREATED_THUMBNAIL, Boolean.toString(encodedImage != null));
            }
