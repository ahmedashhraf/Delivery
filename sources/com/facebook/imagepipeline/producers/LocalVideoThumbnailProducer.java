...
public class LocalVideoThumbnailProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    public void produceResults(Consumer<CloseableReference<CloseableImage>> consumer, ProducerContext producerContext) {
        ...
        final C35371 r0 = new StatefulProducerRunnable<CloseableReference<CloseableImage>>(consumer, listener, PRODUCER_NAME, id) {
            ...
            public Map<String, String> getExtraMapOnSuccess(CloseableReference<CloseableImage> closeableReference) {
                return ImmutableMap.m15725of(LocalVideoThumbnailProducer.CREATED_THUMBNAIL, String.valueOf(closeableReference != null));
            }
            ...
            public CloseableReference<CloseableImage> getResult() throws Exception {
                ...
                return CloseableReference.m15817of(new CloseableStaticBitmap(createVideoThumbnail, (ResourceReleaser<Bitmap>) SimpleBitmapReleaser.getInstance(), ImmutableQualityInfo.FULL_QUALITY, 0));
            }
