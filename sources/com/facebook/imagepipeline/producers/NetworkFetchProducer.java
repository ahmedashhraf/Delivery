...
public class NetworkFetchProducer implements Producer<EncodedImage> {
    ...
    private void notifyConsumer(PooledByteBufferOutputStream pooledByteBufferOutputStream, int i, @C5952h BytesRange bytesRange, Consumer<EncodedImage> consumer) {
