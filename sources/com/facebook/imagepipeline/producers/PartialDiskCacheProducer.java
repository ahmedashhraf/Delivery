...
public class PartialDiskCacheProducer implements Producer<EncodedImage> {
    ...
    private static class PartialDiskCacheConsumer extends DelegatingConsumer<EncodedImage, EncodedImage> {
        ...
        private void sendFinalResultToConsumer(PooledByteBufferOutputStream pooledByteBufferOutputStream) {
            ...
            Throwable th;
            CloseableReference of = CloseableReference.m15817of(pooledByteBufferOutputStream.toByteBuffer());
            try {
        ...
        private PartialDiskCacheConsumer(Consumer<EncodedImage> consumer, BufferedDiskCache bufferedDiskCache, CacheKey cacheKey, PooledByteBufferFactory pooledByteBufferFactory, ByteArrayPool byteArrayPool, @C5952h EncodedImage encodedImage) {
            super(consumer);
            ...
            if (!BaseConsumer.isNotLast(i)) {
                if (this.mPartialEncodedImageFromCache != null && encodedImage.getBytesRange() != null) {
                    try {
                        ...
                        FLog.m15754e(PartialDiskCacheProducer.PRODUCER_NAME, "Error while merging image data", (Throwable) e);
    ...
    private C2175l<EncodedImage, Void> onFinishDiskReads(Consumer<EncodedImage> consumer, ProducerContext producerContext, CacheKey cacheKey) {
        ...
        C35421 r0 = new C2175l<EncodedImage, Void>() {
            public Void then(C2177n<EncodedImage> nVar) throws Exception {
                boolean access$000 = PartialDiskCacheProducer.isTaskCancelled(nVar);
    ...
    /* access modifiers changed from: private */
    public void startInputProducer(Consumer<EncodedImage> consumer, ProducerContext producerContext, CacheKey cacheKey, @C5952h EncodedImage encodedImage) {
    ...
    public void produceResults(Consumer<EncodedImage> consumer, ProducerContext producerContext) {
        ...
        this.mDefaultBufferedDiskCache.get(encodedCacheKey, atomicBoolean).mo9301a(onFinishDiskReads(consumer, producerContext, encodedCacheKey));
