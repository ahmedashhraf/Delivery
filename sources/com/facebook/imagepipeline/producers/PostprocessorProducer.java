...
public class PostprocessorProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private class PostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> {
        @C5966a("PostprocessorConsumer.this")
        ...
        private Map<String, String> getExtraMap(ProducerListener producerListener, String str, Postprocessor postprocessor) {
            ...
            return ImmutableMap.m15725of(PostprocessorProducer.POSTPROCESSOR, postprocessor.getName());
        }
        ...
        private CloseableReference<CloseableImage> postprocessInternal(CloseableImage closeableImage) {
            ...
            try {
                return CloseableReference.m15817of(new CloseableStaticBitmap(process, closeableImage.getQualityInfo(), closeableStaticBitmap.getRotationAngle(), closeableStaticBitmap.getExifOrientation()));
            } finally {
        ...
        private void updateSourceImageRef(@p201f.p202a.C5952h com.facebook.common.references.CloseableReference<com.facebook.imagepipeline.image.CloseableImage> r2, int r3) {
            /*
                r1 = this;
                monitor-enter(r1)
    ...
    class RepeatedPostprocessorConsumer extends DelegatingConsumer<CloseableReference<CloseableImage>, CloseableReference<CloseableImage>> implements RepeatedPostprocessorRunner {
        @C5966a("RepeatedPostprocessorConsumer.this")
        private boolean mIsClosed;
        @C5952h
        @C5966a("RepeatedPostprocessorConsumer.this")
