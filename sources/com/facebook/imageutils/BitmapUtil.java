...
public final class BitmapUtil {
    ...
    private static final C0943c<ByteBuffer> DECODE_BUFFERS = new C0943c<>(12);
    ...
    static /* synthetic */ class C35591 {
        ...
        static {
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.imageutils.BitmapUtil.C35591.<clinit>():void");
        }
    }
    ...
    public static int getPixelSizeForBitmapConfig(Config config) {
        int i = C35591.$SwitchMap$android$graphics$Bitmap$Config[config.ordinal()];
        if (i == 1) {
            return 4;
        }
        if (i == 2) {
    ...
    @SuppressLint({"NewApi"})
    public static int getSizeInBytes(@C5952h Bitmap bitmap) {
        if (bitmap == null) {
            return 0;
        }
    ...
    public static Pair<Integer, Integer> decodeDimensions(InputStream inputStream) {
        ...
        ByteBuffer byteBuffer = (ByteBuffer) DECODE_BUFFERS.mo4743a();
        if (byteBuffer == null) {
