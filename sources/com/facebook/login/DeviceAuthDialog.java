...
public class DeviceAuthDialog extends C1374b {
    ...
    private GraphRequest getPollRequest() {
        ...
        bundle.putString(XHTMLText.CODE, this.currentRequestState.getRequestCode());
    ...
    public void onSuccess(String str, Long l, Long l2) {
        ...
        AccessToken accessToken = new AccessToken(str, FacebookSdk.getApplicationId(), AppEventsConstants.EVENT_PARAM_VALUE_NO, null, null, null, date2, null, date);
    ...
    public void presentConfirmation(String str, PermissionsPair permissionsPair, String str2, String str3, Date date, Date date2) {
        String string = getResources().getString(C3425R.string.com_facebook_smart_login_confirmation_title);
        String string2 = getResources().getString(C3425R.string.com_facebook_smart_login_confirmation_continue_as);
        String string3 = getResources().getString(C3425R.string.com_facebook_smart_login_confirmation_cancel);
    ...
    public int getLayoutResId(boolean z) {
        return z ? C3425R.layout.com_facebook_smart_device_dialog_fragment : C3425R.layout.com_facebook_device_auth_dialog_fragment;
    }

    /* access modifiers changed from: protected */
    public View initializeContentView(boolean z) {
        View inflate = getActivity().getLayoutInflater().inflate(getLayoutResId(z), null);
        this.progressBar = inflate.findViewById(C3425R.C3428id.progress_bar);
        this.confirmationCode = (TextView) inflate.findViewById(C3425R.C3428id.confirmation_code);
        ((Button) inflate.findViewById(C3425R.C3428id.cancel_button)).setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                DeviceAuthDialog.this.onCancel();
            }
        });
        this.instructions = (TextView) inflate.findViewById(C3425R.C3428id.com_facebook_device_auth_instructions);
        this.instructions.setText(Html.fromHtml(getString(C3425R.string.com_facebook_device_auth_instructions)));
        return inflate;
    }
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        this.dialog = new Dialog(getActivity(), C3425R.style.com_facebook_auth_dialog);
