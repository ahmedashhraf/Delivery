...
public class ProfilePictureView extends FrameLayout {
    ...
    private int getPresetSizeInPixels(boolean z) {
        ...
        if (i2 == -4) {
            i = C3624R.dimen.com_facebook_profilepictureview_preset_size_large;
        } else if (i2 == -3) {
            i = C3624R.dimen.com_facebook_profilepictureview_preset_size_normal;
        } else if (i2 == -2) {
            i = C3624R.dimen.com_facebook_profilepictureview_preset_size_small;
        } else if (i2 != -1 || !z) {
            return 0;
        } else {
            i = C3624R.dimen.com_facebook_profilepictureview_preset_size_normal;
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C3624R.styleable.com_facebook_profile_picture_view);
        setPresetSize(obtainStyledAttributes.getInt(C3624R.styleable.com_facebook_profile_picture_view_com_facebook_preset_size, -1));
        this.isCropped = obtainStyledAttributes.getBoolean(C3624R.styleable.com_facebook_profile_picture_view_com_facebook_is_cropped, true);
    ...
    private void setBlankProfilePicture() {
        ...
        if (this.customizedDefaultProfilePicture == null) {
            setImageBitmap(BitmapFactory.decodeResource(getResources(), isCropped() ? C3624R.C3626drawable.com_facebook_profile_picture_blank_square : C3624R.C3626drawable.com_facebook_profile_picture_blank_portrait));
            return;
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (MeasureSpec.getMode(i2) == 1073741824 || layoutParams.height != -2) {
            ...
            i2 = MeasureSpec.makeMeasureSpec(size, C6637f.f18605b);
            z = true;
        }
        if (MeasureSpec.getMode(i) != 1073741824 && layoutParams.width == -2) {
            size2 = getPresetSizeInPixels(true);
            i = MeasureSpec.makeMeasureSpec(size2, C6637f.f18605b);
            z = true;
        }
        if (z) {
    ...
    public final void setProfileId(@C0195i0 String str) {
        boolean z;
