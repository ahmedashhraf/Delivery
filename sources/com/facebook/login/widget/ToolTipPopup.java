...
public class ToolTipPopup {
    ...
    private class PopupContentView extends FrameLayout {
        ...
        private void init() {
            LayoutInflater.from(getContext()).inflate(C3624R.layout.com_facebook_tooltip_bubble, this);
            this.topArrow = (ImageView) findViewById(C3624R.C3627id.com_facebook_tooltip_bubble_view_top_pointer);
            this.bottomArrow = (ImageView) findViewById(C3624R.C3627id.com_facebook_tooltip_bubble_view_bottom_pointer);
            this.bodyFrame = findViewById(C3624R.C3627id.com_facebook_body_frame);
            this.xOut = (ImageView) findViewById(C3624R.C3627id.com_facebook_button_xout);
        }
    ...
    public void show() {
        if (this.mAnchorViewRef.get() != null) {
            ...
            ((TextView) this.mPopupContent.findViewById(C3624R.C3627id.com_facebook_tooltip_bubble_view_text_body)).setText(this.mText);
            if (this.mStyle == Style.BLUE) {
                this.mPopupContent.bodyFrame.setBackgroundResource(C3624R.C3626drawable.com_facebook_tooltip_blue_background);
                this.mPopupContent.bottomArrow.setImageResource(C3624R.C3626drawable.com_facebook_tooltip_blue_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C3624R.C3626drawable.com_facebook_tooltip_blue_topnub);
                this.mPopupContent.xOut.setImageResource(C3624R.C3626drawable.com_facebook_tooltip_blue_xout);
            } else {
                this.mPopupContent.bodyFrame.setBackgroundResource(C3624R.C3626drawable.com_facebook_tooltip_black_background);
                this.mPopupContent.bottomArrow.setImageResource(C3624R.C3626drawable.com_facebook_tooltip_black_bottomnub);
                this.mPopupContent.topArrow.setImageResource(C3624R.C3626drawable.com_facebook_tooltip_black_topnub);
                this.mPopupContent.xOut.setImageResource(C3624R.C3626drawable.com_facebook_tooltip_black_xout);
            }
