...
public class MessengerUtils {
    ...
    public static void finishShareToMessenger(Activity activity, ShareToMessengerParams shareToMessengerParams) {
        ...
        String str = ORCA_THREAD_CATEGORY_20150314;
        if (categories.contains(str)) {
            Bundle b = C2165e.m11195b(intent);
            Intent intent2 = new Intent();
            if (categories.contains(str)) {
                intent2.putExtra(EXTRA_PROTOCOL_VERSION, PROTOCOL_VERSION_20150314);
                String str2 = EXTRA_THREAD_TOKEN_KEY;
                intent2.putExtra(str2, b.getString(str2));
    ...
    private static Set<Integer> getAllAvailableProtocolVersions(Context context) {
        ...
        String str = "version";
        Cursor query = contentResolver.query(Uri.parse("content://com.facebook.orca.provider.MessengerPlatformProvider/versions"), new String[]{str}, null, null, null);
        if (query != null) {
            try {
