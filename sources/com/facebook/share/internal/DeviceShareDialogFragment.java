...
public class DeviceShareDialogFragment extends C1374b {
    ...
    private void detach() {
        if (isAdded()) {
            getFragmentManager().mo6224a().mo6094d((Fragment) this).mo6097e();
        }
    }
    ...
    public Dialog onCreateDialog(Bundle bundle) {
        ...
        View inflate = getActivity().getLayoutInflater().inflate(C3425R.layout.com_facebook_device_auth_dialog_fragment, null);
        this.progressBar = (ProgressBar) inflate.findViewById(C3425R.C3428id.progress_bar);
        this.confirmationCode = (TextView) inflate.findViewById(C3425R.C3428id.confirmation_code);
        ((Button) inflate.findViewById(C3425R.C3428id.cancel_button)).setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                DeviceShareDialogFragment.this.dialog.dismiss();
            }
        });
        ((TextView) inflate.findViewById(C3425R.C3428id.com_facebook_device_auth_instructions)).setText(Html.fromHtml(getString(C3425R.string.com_facebook_device_auth_instructions)));
