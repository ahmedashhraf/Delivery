...
public class LikeActionController {
    ...
    static /* synthetic */ class C370012 {
    ...
    /* JADX WARNING: type inference failed for: r0v1, types: [com.facebook.share.internal.LikeActionController] */
    ...
    /* JADX WARNING: type inference failed for: r0v7, types: [com.facebook.share.internal.LikeActionController] */
    ...
    /* JADX WARNING: Multi-variable type inference failed. Error: jadx.core.utils.exceptions.JadxRuntimeException: No candidate types for var: r0v0
      assigns: [?[int, float, boolean, short, byte, char, OBJECT, ARRAY], ?[OBJECT, ARRAY], com.facebook.share.internal.LikeActionController]
      uses: [com.facebook.share.internal.LikeActionController, ?[int, boolean, OBJECT, ARRAY, byte, short, char], java.io.Closeable]
      mth insns count: 26
    ...
    private static com.facebook.share.internal.LikeActionController deserializeFromDiskSynchronously(java.lang.String r4) {
        /*
            r0 = 0
            java.lang.String r4 = getCacheKeyForObjectId(r4)     // Catch:{ IOException -> 0x002e, all -> 0x0027 }
            com.facebook.internal.FileLruCache r1 = controllerDiskCache     // Catch:{ IOException -> 0x002e, all -> 0x0027 }
            java.io.InputStream r4 = r1.get(r4)     // Catch:{ IOException -> 0x002e, all -> 0x0027 }
            if (r4 == 0) goto L_0x0021
            java.lang.String r1 = com.facebook.internal.Utility.readStreamToString(r4)     // Catch:{ IOException -> 0x002f, all -> 0x001c }
            boolean r2 = com.facebook.internal.Utility.isNullOrEmpty(r1)     // Catch:{ IOException -> 0x002f, all -> 0x001c }
            if (r2 != 0) goto L_0x0021
            com.facebook.share.internal.LikeActionController r0 = deserializeFromJson(r1)     // Catch:{ IOException -> 0x002f, all -> 0x001c }
            goto L_0x0021
        L_0x001c:
            r0 = move-exception
            r3 = r0
    ...
    private void presentLikeDialog(Activity activity, FragmentWrapper fragmentWrapper, Bundle bundle) {
        ...
        if (str != null) {
            ...
            saveState(bundle);
            getAppEventsLogger().logSdkEvent(str3, null, bundle);
        }
    }
        ...
        if (!AccessToken.isCurrentAccessTokenActive()) {
            ...
            fetchVerifiedObjectId(new RequestCompletionCallback() {
                public void onComplete() {
                    ...
                    if (C370012.$SwitchMap$com$facebook$share$widget$LikeView$ObjectType[LikeActionController.this.objectType.ordinal()] != 1) {
                        LikeActionController likeActionController = LikeActionController.this;
    ...
    public static void broadcastAction(LikeActionController likeActionController, String str, Bundle bundle) {
        ...
        C2128a.m11089a(FacebookSdk.getApplicationContext()).mo9219a(intent);
    }
