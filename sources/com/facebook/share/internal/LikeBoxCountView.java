...
public class LikeBoxCountView extends FrameLayout {
    ...
    static /* synthetic */ class C37121 {

        /* renamed from: $SwitchMap$com$facebook$share$internal$LikeBoxCountView$LikeBoxCountViewCaretPosition */
        static final /* synthetic */ int[] f11796x5851190f = new int[LikeBoxCountViewCaretPosition.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f11796x5851190f = r0
                int[] r0 = f11796x5851190f     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f11796x5851190f     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f11796x5851190f     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                int[] r0 = f11796x5851190f     // Catch:{ NoSuchFieldError -> 0x0035 }
            ...
            L_0x0035:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.LikeBoxCountView.C37121.<clinit>():void");
        }
    }
    ...
    private void initialize(Context context) {
        ...
        this.caretHeight = getResources().getDimension(C3425R.dimen.com_facebook_likeboxcountview_caret_height);
        this.caretWidth = getResources().getDimension(C3425R.dimen.com_facebook_likeboxcountview_caret_width);
        this.borderRadius = getResources().getDimension(C3425R.dimen.com_facebook_likeboxcountview_border_radius);
        this.borderPaint = new Paint();
        this.borderPaint.setColor(getResources().getColor(C3425R.C3426color.com_facebook_likeboxcountview_border_color));
        this.borderPaint.setStrokeWidth(getResources().getDimension(C3425R.dimen.com_facebook_likeboxcountview_border_width));
    ...
    private void initializeLikeCountLabel(Context context) {
        ...
        this.likeCountLabel.setTextSize(0, getResources().getDimension(C3425R.dimen.com_facebook_likeboxcountview_text_size));
        this.likeCountLabel.setTextColor(getResources().getColor(C3425R.C3426color.com_facebook_likeboxcountview_text_color));
        this.textPadding = getResources().getDimensionPixelSize(C3425R.dimen.com_facebook_likeboxcountview_text_padding);
        this.additionalTextPadding = getResources().getDimensionPixelSize(C3425R.dimen.com_facebook_likeboxcountview_caret_height);
    }
    ...
    public void onDraw(Canvas canvas) {
        ...
        int i = C37121.f11796x5851190f[this.caretPosition.ordinal()];
        if (i == 1) {
    ...
    public void setCaretPosition(LikeBoxCountViewCaretPosition likeBoxCountViewCaretPosition) {
        ...
        int i = C37121.f11796x5851190f[likeBoxCountViewCaretPosition.ordinal()];
        if (i == 1) {
