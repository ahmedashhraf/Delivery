...
public class MessengerShareContentUtility {
    ...
    static /* synthetic */ class C37171 {
        ...
        static {
            /*
                ...
                f11798x2a75e664 = r0
                r0 = 1
                int[] r1 = f11798x2a75e664     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                ...
                int[] r1 = new int[r1]
                f11797xb7309c05 = r1
                int[] r1 = f11797xb7309c05     // Catch:{ NoSuchFieldError -> 0x0027 }
            ...
            L_0x0027:
                ...
                int[] r1 = new int[r1]
                f11799x92e77847 = r1
                int[] r1 = f11799x92e77847     // Catch:{ NoSuchFieldError -> 0x003a }
            ...
            L_0x003a:
                int[] r0 = f11799x92e77847     // Catch:{ NoSuchFieldError -> 0x0045 }
            ...
            L_0x0045:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.internal.MessengerShareContentUtility.C37171.<clinit>():void");
        }
    }
    ...
    private static String getImageRatioString(ImageAspectRatio imageAspectRatio) {
        ...
        return (imageAspectRatio != null && C37171.f11797xb7309c05[imageAspectRatio.ordinal()] == 1) ? IMAGE_RATIO_SQUARE : str;
    }

    private static String getMediaType(MediaType mediaType) {
        String str = "image";
        return (mediaType != null && C37171.f11798x2a75e664[mediaType.ordinal()] == 1) ? "video" : str;
    }
    ...
    private static String getWebviewHeightRatioString(WebviewHeightRatio webviewHeightRatio) {
        ...
        int i = C37171.f11799x92e77847[webviewHeightRatio.ordinal()];
        if (i != 1) {
