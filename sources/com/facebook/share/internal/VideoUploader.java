...
public class VideoUploader {
    ...
    private static class TransferChunkWorkItem extends UploadWorkItemBase {
        ...
        public Bundle getParameters() throws IOException {
            Bundle bundle = new Bundle();
            bundle.putString(VideoUploader.PARAM_UPLOAD_PHASE, "transfer");
            bundle.putString(VideoUploader.PARAM_SESSION_ID, this.uploadContext.sessionId);
    ...
    private static class UploadContext {
        ...
        private UploadContext(ShareVideoContent shareVideoContent, String str, FacebookCallback<Result> facebookCallback) {
            ...
            if (!Utility.isNullOrEmpty((Collection<T>) shareVideoContent.getPeopleIds())) {
                this.params.putString(State.KEY_TAGS, TextUtils.join(", ", shareVideoContent.getPeopleIds()));
            }
    ...
    private static abstract class UploadWorkItemBase implements Runnable {
        ...
        public void executeGraphRequestSynchronously(Bundle bundle) {
            ...
            GraphRequest graphRequest = new GraphRequest(uploadContext2.accessToken, String.format(Locale.ROOT, "%s/videos", new Object[]{uploadContext2.graphNode}), bundle2, HttpMethod.POST, null);
    ...
    public static void issueResponse(UploadContext uploadContext, FacebookException facebookException, String str) {
        ...
        FacebookCallback<Result> facebookCallback = uploadContext.callback;
