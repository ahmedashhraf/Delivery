...
public final class ShareMediaContent extends ShareContent<ShareMediaContent, Builder> {
    ...
    public static class Builder extends com.facebook.share.model.ShareContent.Builder<ShareMediaContent, Builder> {
        ...
        public Builder addMedia(@C0195i0 List<ShareMedia> list) {
            if (list != null) {
        ...
        public Builder addMedium(@C0195i0 ShareMedia shareMedia) {
            Object obj;
            if (shareMedia != null) {
        ...
        public Builder setMedia(@C0195i0 List<ShareMedia> list) {
            this.media.clear();
            addMedia(list);
            return this;
        }
