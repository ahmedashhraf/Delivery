...
public final class SharePhotoContent extends ShareContent<SharePhotoContent, Builder> {
    ...
    public static class Builder extends com.facebook.share.model.ShareContent.Builder<SharePhotoContent, Builder> {
        ...
        public Builder addPhoto(@C0195i0 SharePhoto sharePhoto) {
            if (sharePhoto != null) {
        ...
        public Builder addPhotos(@C0195i0 List<SharePhoto> list) {
            if (list != null) {
        ...
        public Builder setPhotos(@C0195i0 List<SharePhoto> list) {
            this.photos.clear();
            addPhotos(list);
            return this;
        }
