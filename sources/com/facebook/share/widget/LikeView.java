...
public class LikeView extends FrameLayout {
    ...
    static /* synthetic */ class C37712 {
        ...
        static final /* synthetic */ int[] f11802x30689ac = new int[AuxiliaryViewPosition.values().length];
        ...
        static {
            /*
                ...
                int[] r0 = new int[r0]
                f11802x30689ac = r0
                int[] r0 = f11802x30689ac     // Catch:{ NoSuchFieldError -> 0x0014 }
            ...
            L_0x0014:
                int[] r0 = f11802x30689ac     // Catch:{ NoSuchFieldError -> 0x001f }
            ...
            L_0x001f:
                int[] r0 = f11802x30689ac     // Catch:{ NoSuchFieldError -> 0x002a }
            ...
            L_0x002a:
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.share.widget.LikeView.C37712.<clinit>():void");
        }
    }
    ...
    public void associateWithLikeActionController(LikeActionController likeActionController2) {
        ...
        C2128a a = C2128a.m11089a(getContext());
        ...
        a.mo9218a(this.broadcastReceiver, intentFilter);
    }
    ...
    private void initialize(Context context) {
        this.edgePadding = getResources().getDimensionPixelSize(C3425R.dimen.com_facebook_likeview_edge_padding);
        this.internalPadding = getResources().getDimensionPixelSize(C3425R.dimen.com_facebook_likeview_internal_padding);
        if (this.foregroundColor == -1) {
            this.foregroundColor = getResources().getColor(C3425R.C3426color.com_facebook_likeview_text_color);
        }
    ...
    private void initializeSocialSentenceView(Context context) {
        ...
        this.socialSentenceView.setTextSize(0, getResources().getDimension(C3425R.dimen.com_facebook_likeview_text_size));
    ...
    private void parseAttributes(AttributeSet attributeSet) {
        if (attributeSet != null && getContext() != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, C3425R.styleable.com_facebook_like_view);
            if (obtainStyledAttributes != null) {
                this.objectId = Utility.coerceValueIfNullOrEmpty(obtainStyledAttributes.getString(C3425R.styleable.com_facebook_like_view_com_facebook_object_id), null);
                this.objectType = ObjectType.fromInt(obtainStyledAttributes.getInt(C3425R.styleable.com_facebook_like_view_com_facebook_object_type, ObjectType.DEFAULT.getValue()));
                this.likeViewStyle = Style.fromInt(obtainStyledAttributes.getInt(C3425R.styleable.com_facebook_like_view_com_facebook_style, Style.DEFAULT.getValue()));
                if (this.likeViewStyle != null) {
                    this.auxiliaryViewPosition = AuxiliaryViewPosition.fromInt(obtainStyledAttributes.getInt(C3425R.styleable.com_facebook_like_view_com_facebook_auxiliary_view_position, AuxiliaryViewPosition.DEFAULT.getValue()));
                    if (this.auxiliaryViewPosition != null) {
                        this.horizontalAlignment = HorizontalAlignment.fromInt(obtainStyledAttributes.getInt(C3425R.styleable.com_facebook_like_view_com_facebook_horizontal_alignment, HorizontalAlignment.DEFAULT.getValue()));
                        if (this.horizontalAlignment != null) {
                            this.foregroundColor = obtainStyledAttributes.getColor(C3425R.styleable.com_facebook_like_view_com_facebook_foreground_color, -1);
    ...
    private void tearDownObjectAssociations() {
        if (this.broadcastReceiver != null) {
            C2128a.m11089a(getContext()).mo9217a(this.broadcastReceiver);
    ...
    private void updateBoxCountCaretPosition() {
        int i = C37712.f11802x30689ac[this.auxiliaryViewPosition.ordinal()];
        if (i == 1) {
    ...
    private void updateLayout() {
        ...
        L_0x0098:
            ...
            r1.addView(r2)
        L_0x00a6:
            int[] r1 = com.facebook.share.widget.LikeView.C37712.f11802x30689ac
