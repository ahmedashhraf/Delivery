...
public class StreetViewPanorama {
    ...
    public StreetViewPanorama(@C0193h0 IStreetViewPanoramaDelegate iStreetViewPanoramaDelegate) {
        this.zzbn = (IStreetViewPanoramaDelegate) C4300a0.m18621a(iStreetViewPanoramaDelegate, (Object) "delegate");
    }
    ...
    public Point orientationToPoint(StreetViewPanoramaOrientation streetViewPanoramaOrientation) {
        try {
            C4519d orientationToPoint = this.zzbn.orientationToPoint(streetViewPanoramaOrientation);
            if (orientationToPoint == null) {
                return null;
            }
            return (Point) C4523f.m19512d(orientationToPoint);
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
    ...
    public StreetViewPanoramaOrientation pointToOrientation(Point point) {
        try {
            return this.zzbn.pointToOrientation(C4523f.m19511a(point));
        } catch (RemoteException e) {
            throw new RuntimeRemoteException(e);
        }
    }
