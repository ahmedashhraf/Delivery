...
public final class C5382r5 {
    /* renamed from: a */
    public static void m23401a(@C0193h0 Bundle bundle, @C0193h0 Object obj) {
        String str = "value";
    ...
    /* renamed from: a */
    public static <T> T m23400a(@C0193h0 Bundle bundle, String str, Class<T> cls, T t) {
        T t2 = bundle.get(str);
        if (t2 == null) {
            return t;
        }
