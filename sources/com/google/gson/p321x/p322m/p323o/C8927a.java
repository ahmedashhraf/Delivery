package com.google.gson.p321x.p322m.p323o;
...
/* renamed from: com.google.gson.x.m.o.a */
/* compiled from: ISO8601Utils */
public class C8927a {

    /* renamed from: a */
    private static final String f23358a = "UTC";

    /* renamed from: b */
    private static final TimeZone f23359b = TimeZone.getTimeZone(f23358a);

    /* renamed from: a */
    public static String m41687a(Date date) {
        return m41689a(date, false, f23359b);
    }

    /* renamed from: a */
    public static String m41688a(Date date, boolean z) {
        return m41689a(date, z, f23359b);
    }

    /* renamed from: a */
    public static String m41689a(Date date, boolean z, TimeZone timeZone) {
        GregorianCalendar gregorianCalendar = new GregorianCalendar(timeZone, Locale.US);
        gregorianCalendar.setTime(date);
        StringBuilder sb = new StringBuilder(19 + (z ? 4 : 0) + (timeZone.getRawOffset() == 0 ? 1 : 6));
        m41691a(sb, gregorianCalendar.get(1), 4);
        char c = '-';
        sb.append('-');
        m41691a(sb, gregorianCalendar.get(2) + 1, 2);
        sb.append('-');
        m41691a(sb, gregorianCalendar.get(5), 2);
        sb.append('T');
        m41691a(sb, gregorianCalendar.get(11), 2);
        sb.append(':');
        m41691a(sb, gregorianCalendar.get(12), 2);
        sb.append(':');
        m41691a(sb, gregorianCalendar.get(13), 2);
        if (z) {
            sb.append('.');
            m41691a(sb, gregorianCalendar.get(14), 3);
        }
    ...
    public static java.util.Date m41690a(java.lang.String r18, java.text.ParsePosition r19) throws java.text.ParseException {
        /*
            r1 = r18
            r2 = r19
            java.lang.String r3 = "'"
            ...
            int r4 = r0 + 4
            int r0 = m41686a(r1, r0, r4)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r5 = 45
            boolean r6 = m41692a(r1, r4, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r6 == 0) goto L_0x001a
            int r4 = r4 + 1
        L_0x001a:
            int r6 = r4 + 2
            int r4 = m41686a(r1, r4, r6)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            boolean r7 = m41692a(r1, r6, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r7 == 0) goto L_0x0028
            int r6 = r6 + 1
        L_0x0028:
            int r7 = r6 + 2
            int r6 = m41686a(r1, r6, r7)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r8 = 84
            boolean r8 = m41692a(r1, r7, r8)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r9 = 1
        ...
        L_0x004b:
            ...
            int r7 = r7 + 1
            int r8 = r7 + 2
            int r7 = m41686a(r1, r7, r8)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r14 = 58
            boolean r15 = m41692a(r1, r8, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r15 == 0) goto L_0x0064
            int r8 = r8 + 1
        L_0x0064:
            int r15 = r8 + 2
            int r8 = m41686a(r1, r8, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            boolean r14 = m41692a(r1, r15, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
        ...
        L_0x0072:
            ...
            int r14 = r15 + 2
            int r15 = m41686a(r1, r15, r14)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r12 = 59
        ...
        L_0x0094:
            r15 = 46
            boolean r15 = m41692a(r1, r14, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            if (r15 == 0) goto L_0x00bc
            int r14 = r14 + 1
            int r15 = r14 + 1
            int r15 = m41685a(r1, r15)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            int r5 = r14 + 3
            ...
            int r17 = m41686a(r1, r14, r5)     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            int r5 = r5 - r14
        ...
        L_0x00c6:
            ...
            java.util.TimeZone r10 = f23359b     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            int r15 = r15 + r9
            goto L_0x0181
        L_0x00d8:
        ...
        L_0x017c:
            ...
            goto L_0x0181
        L_0x017e:
            java.util.TimeZone r9 = f23359b     // Catch:{ IndexOutOfBoundsException -> 0x01bf, NumberFormatException -> 0x01bd, IllegalArgumentException -> 0x01bb }
            r10 = r9
        L_0x0181:
        ...
        L_0x0202:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.gson.p321x.p322m.p323o.C8927a.m41690a(java.lang.String, java.text.ParsePosition):java.util.Date");
    }

    /* renamed from: a */
    private static boolean m41692a(String str, int i, char c) {
        return i < str.length() && str.charAt(i) == c;
    }

    /* renamed from: a */
    private static int m41686a(String str, int i, int i2) throws NumberFormatException {
        int i3;
        int i4;
    ...
    /* renamed from: a */
    private static void m41691a(StringBuilder sb, int i, int i2) {
    ...
    /* renamed from: a */
    private static int m41685a(String str, int i) {
        while (i < str.length()) {
