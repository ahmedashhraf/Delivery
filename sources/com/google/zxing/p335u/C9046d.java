...
/* renamed from: com.google.zxing.u.d */
...
public enum C9046d {
    ...
    ASCII((String) new int[]{27, C13959t.f40792G2}, (int) new String[]{"US-ASCII"}),
    Big5(28),
    GB18030((String) 29, (int) new String[]{C9054l.f23706c, "EUC_CN", "GBK"}),
    EUC_KR((String) 30, (int) new String[]{"EUC-KR"});
    
    private static final Map<String, C9046d> NAME_TO_ECI = null;
    private static final Map<Integer, C9046d> VALUE_TO_ECI = null;
    ...
    private C9046d(int i) {
        this(r3, r4, new int[]{i}, new String[0]);
    }

    /* renamed from: a */
    public static C9046d m42322a(int i) throws FormatException {
        if (i >= 0 && i < 900) {
            return (C9046d) VALUE_TO_ECI.get(Integer.valueOf(i));
        }
        throw FormatException.m41710a();
    }

    /* renamed from: b */
    public static C9046d m42323b(String str) {
        return (C9046d) NAME_TO_ECI.get(str);
    }
    ...
    private C9046d(int i, String... strArr) {
        this.values = new int[]{i};
        this.otherEncodingNames = strArr;
    }

    private C9046d(int[] iArr, String... strArr) {
        this.values = iArr;
        this.otherEncodingNames = strArr;
    }
}
