...
public class InstabugLogoProvider {
    ...
    private static /* synthetic */ boolean[] $jacocoInit() {
        ...
        boolean[] a = C13938g.m59885a(7534561917176920216L, "com/instabug/library/util/InstabugLogoProvider", 5);
        $jacocoData = a;
        return a;
    }

    public InstabugLogoProvider() {
        $jacocoInit()[0] = true;
    }

    public static Bitmap getInstabugHoloLogo() {
    ...
    public static Bitmap getInstabugLogo() {
        boolean[] $jacocoInit = $jacocoInit();
        byte[] decode = Base64.decode(INSTABUG_LOGO.getBytes(Charset.forName("UTF-8")), 0);
        $jacocoInit[1] = true;
        Bitmap decodeByteArray = BitmapFactory.decodeByteArray(decode, 0, decode.length);
        $jacocoInit[2] = true;
        return decodeByteArray;
