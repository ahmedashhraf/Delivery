...
@C6144b
/* renamed from: org.apache.http.impl.client.j */
/* compiled from: DefaultProxyAuthenticationHandler */
public class C15378j extends C15369a {
    /* renamed from: a */
    public boolean mo46922a(C15466r rVar, C15431f fVar) {
        if (rVar != null) {
            return rVar.mo47468l().mo46913c() == 407;
        }
    ...
    public Map<String, C15133c> mo46923b(C15466r rVar, C15431f fVar) throws MalformedChallengeException {
        if (rVar != null) {
            return mo47577a(rVar.mo47422c("Proxy-Authenticate"));
        }
        throw new IllegalArgumentException("HTTP response may not be null");
    }
}
