...
public class MPEGPredQuad extends MPEGPred {
    ...
    private void predictEvenOddSafe(int[] iArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, int[] iArr2, int i8, int i9, int i10, int i11) {
        ...
        for (int i19 = 0; i19 < i18; i19++) {
            ...
            while (i22 < i12) {
                int i23 = i20 + 1;
                i21++;
                iArr2[i20] = (((iArr[i21] * i15) + (iArr[i21] * i2)) + 2) >> 2;
                i22++;
                i20 = i23;
            }
            i16 = i21 + i13;
    ...
    private void predictOddEvenSafe(int[] iArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, int[] iArr2, int i8, int i9, int i10, int i11) {
        ...
        for (int i20 = 0; i20 < i19; i20++) {
            ...
            while (i23 < i12) {
                int i24 = i21 + 1;
                iArr2[i21] = (((iArr[i22] * i16) + (iArr[i22 + i13] * i3)) + 2) >> 2;
                i22++;
                i23++;
                i21 = i24;
            }
    ...
    private void predictOddOddSafe(int[] iArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int[] iArr2, int i9, int i10, int i11, int i12) {
        ...
        for (int i22 = 0; i22 < i21; i22++) {
            ...
            while (i25 < i13) {
                ...
                int i27 = i24 + 1;
                int i28 = i24 + i14;
                iArr2[i23] = ((((((iArr[i24] * i17) * i18) + ((iArr[i27] * i2) * i18)) + ((iArr[i28] * i17) * i4)) + ((iArr[i28 + 1] * i2) * i4)) + 8) >> 4;
                i25++;
                i23 = i26;
                i24 = i27;
            }
    ...
    public int getPix4(int[] iArr, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9, int i10, int i11, int i12, int i13, int i14) {
        ...
        int i19 = 4 - i13;
        int i20 = 4 - i14;
        return ((((((iArr[(MathUtil.clip(i4, 0, i15) * i) + MathUtil.clip(i3, 0, i16)] * i19) * i20) + ((iArr[(MathUtil.clip(i6, 0, i15) * i) + MathUtil.clip(i5, 0, i16)] * i13) * i20)) + ((iArr[(MathUtil.clip(i8, 0, i15) * i) + MathUtil.clip(i7, 0, i16)] * i19) * i14)) + ((iArr[(MathUtil.clip(i10, 0, i15) * i) + MathUtil.clip(i9, 0, i16)] * i13) * i14)) + 8) >> 4;
    }
