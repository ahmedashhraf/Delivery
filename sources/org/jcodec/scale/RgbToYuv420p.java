    ...
    public void transform(Picture picture, Picture picture2) {
        ...
        while (i < (picture.getHeight() >> 1)) {
            ...
            for (int i6 = 0; i6 < (picture.getWidth() >> 1); i6++) {
                ...
                data[0][i3] = (data[0][i3] << this.upShift) >> this.downShift;
                int i9 = i4 + width;
                int i10 = i3 + width2;
                rgb2yuv(iArr[i9], iArr[i9 + 1], iArr[i9 + 2], data[0], i10, data[1], i7, data[2], i8);
                data[0][i10] = (data[0][i10] << this.upShift) >> this.downShift;
                int i11 = i3 + 1;
                rgb2yuv(iArr[i4 + 3], iArr[i4 + 4], iArr[i4 + 5], data[0], i11, data[1], i7, data[2], i8);
                data[0][i11] = (data[0][i11] << this.upShift) >> this.downShift;
                int i12 = i11 + width2;
                rgb2yuv(iArr[i9 + 3], iArr[i9 + 4], iArr[i9 + 5], data[0], i12, data[1], i7, data[2], i8);
                int[] iArr2 = data[0];
                int i13 = data[0][i12];
                int i14 = this.upShift;
                iArr2[i12] = (i13 << i14) >> this.downShift;
                i3 = i11 + 1;
                int[] iArr3 = data[1];
                int i15 = data[1][i5] << i14;
                int i16 = this.downShiftChr;
                iArr3[i5] = i15 >> i16;
                data[2][i5] = (data[2][i5] << i14) >> i16;
                i5++;
                i4 += 6;
            }
            i3 += width2;
