...
public class AbstractError {
    ...
    public void addDescriptiveTextsAndExtensions(XmlStringBuilder xmlStringBuilder) {
        for (Entry entry : this.descriptiveTexts.entrySet()) {
            ...
            String str3 = "text";
            xmlStringBuilder.halfOpenElement(str3).xmlnsAttribute(this.textNamespace).xmllangAttribute(str).rightAngleBracket();
            xmlStringBuilder.escape(str2);
            xmlStringBuilder.closeElement(str3);
        }
        for (ExtensionElement xml : this.extensions) {
