...
final class Utils {
    ...
    static final class ParameterizedTypeImpl implements ParameterizedType {
        ...
        ParameterizedTypeImpl(@C5952h Type type, Type type2, Type... typeArr) {
    ...
    static C13826f0 buffer(C13826f0 f0Var) throws IOException {
        C13887c cVar = new C13887c();
        f0Var.source().mo43844a((C13924z) cVar);
        return C13826f0.create(f0Var.contentType(), f0Var.contentLength(), cVar);
    }

    static <T> T checkNotNull(@C5952h T t, String str) {
        if (t != null) {
            return t;
        }
    ...
    static boolean hasUnresolvableType(@C5952h Type type) {
        String str;
        if (type instanceof Class) {
            return false;
        }
    ...
    static RuntimeException methodError(Method method, @C5952h Throwable th, String str, Object... objArr) {
